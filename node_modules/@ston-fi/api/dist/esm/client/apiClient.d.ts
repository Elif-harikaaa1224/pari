import { LiquidityProvisionSimulationQuery, LiquidityProvisionType } from './types/liquidityProvision.js';
import { AssetTag } from './types/asset.js';
...
declare class StonApiClient {
    ...
    getAssetsFeeStats({ since, until, referrerAddress, }: {
        since: Date;
        until: Date;
    ...
    getWithdrawalsFeeStats({ since, until, referrerAddress, }: {
        since: Date;
        until: Date;
        referrerAddress: string;
    }): Promise<{
    ...
    getAccrualsFeeStats({ since, until, referrerAddress, }: {
        since: Date;
        until: Date;
        referrerAddress: string;
    }): Promise<{
