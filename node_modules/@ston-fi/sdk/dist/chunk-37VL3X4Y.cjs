...
var FarmNftItemV3 = (_class = class _FarmNftItemV3 extends _chunkIIMQROIVcjs.Contract {
  ...
  async getClaimRewardsTxParams(provider, params) {
    ...
    const value = this.gasConstants.claimRewardsBase + this.gasConstants.claimRewardsPerPool * BigInt(Math.max(poolCount - 1, 0));
  ...
  async getUnstakeTxParams(provider, params) {
    ...
    const value = this.gasConstants.unstakeBase + this.gasConstants.unstakePerPool * BigInt(Math.max(poolCount - 1, 0));
    return { to, value, body };
  }
...
//# sourceMappingURL=chunk-37VL3X4Y.cjs.map