...
import { RouterV2_1, PoolV2_1 } from './contracts/dex/v2_1/index.js';
...
import { DEX_TYPE } from './contracts/dex/constants.js';
...
import { CPIRouterV2_1 } from './contracts/dex/v2_1/router/CPIRouterV2_1.js';
import { CPIPoolV2_1 } from './contracts/dex/v2_1/pool/CPIPoolV2_1.js';
import { StableRouterV2_1 } from './contracts/dex/v2_1/router/StableRouterV2_1.js';
import { StablePoolV2_1 } from './contracts/dex/v2_1/pool/StablePoolV2_1.js';
import { WCPIRouterV2_1 } from './contracts/dex/v2_1/router/WCPIRouterV2_1.js';
import { WCPIPoolV2_1 } from './contracts/dex/v2_1/pool/WCPIPoolV2_1.js';
import { WStableRouterV2_1 } from './contracts/dex/v2_1/router/WStableRouterV2_1.js';
import { WStablePoolV2_1 } from './contracts/dex/v2_1/pool/WStablePoolV2_1.js';
import '@ton/ton';
import './types.js';
...
declare function routerFactory(routerInfo: Pick<RouterInfo, "address" | "majorVersion" | "minorVersion"> & {
    routerType?: RouterInfo["routerType"] | DEX_TYPE;
}): RouterV1 | CPIRouterV2_1 | StableRouterV2_1 | WCPIRouterV2_1 | WStableRouterV2_1 | RouterV2_1;
